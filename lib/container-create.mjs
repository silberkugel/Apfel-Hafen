...
export function validateContainerDraft(input, basePath, occupiedPorts = []) {
  ...
  return { name, image, cpus, memoryMb, start: Boolean(input.start), arguments: argumentsList, variables: normalizedVariables, ports: normalizedPorts, volumes: normalizedVolumes };
}
