...
export function validateLaunchdDraft(input) {
  ...
  return { label, program, arguments: argumentsList, runAtLoad: input.runAtLoad === true, keepAlive: input.keepAlive === true, loadNow: input.loadNow !== false, standardOutPath, standardErrorPath };
}
