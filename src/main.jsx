...
const translations = {
  de: {
    ...
    check: "Update prüfen", replace: "Container ersetzen", update: "Update verfügbar", noMatches: "Keine passenden Container gefunden.", delete: "Löschen", settings: "Einstellungen", console: "Konsole öffnen", moreActions: "Weitere Aktionen",
  ...
  en: {
    ...
    check: "Check update", replace: "Replace container", update: "Update available", noMatches: "No matching containers found.", delete: "Delete", settings: "Settings", console: "Open console", moreActions: "More actions",
...
const emptyLaunchdDraft = () => ({ label: "", program: "", argumentsText: "", runAtLoad: true, keepAlive: false, loadNow: true, standardOutPath: "", standardErrorPath: "" });
...
function App() {
  ...
  async function createService(event) {
    ...
    try {
      const payload = { ...serviceDraft, arguments: serviceDraft.argumentsText.split("\n").map((value) => value.trim()).filter(Boolean) };
