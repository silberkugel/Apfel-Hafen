...
const translations = {
  de: {
    ...
    check: "Update prüfen", replace: "Container ersetzen", update: "Update verfügbar", noMatches: "Keine passenden Container gefunden.", delete: "Löschen", settings: "Einstellungen", console: "Konsole öffnen", logs: "Startprotokoll anzeigen", bootLog: "Bootprotokoll", containerOutput: "Container-Ausgaben (letzte 200 Zeilen)", noLogOutput: "Keine Protokollausgabe vorhanden.", moreActions: "Weitere Aktionen",
