...
const translations = {
  de: {
    ...
    check: "Update prüfen", replace: "Container ersetzen", update: "Update verfügbar", noMatches: "Keine passenden Container gefunden.", delete: "Löschen", settings: "Einstellungen", moreActions: "Weitere Aktionen",
  ...
  en: {
    ...
    check: "Check update", replace: "Replace container", update: "Update available", noMatches: "No matching containers found.", delete: "Delete", settings: "Settings", moreActions: "More actions",
