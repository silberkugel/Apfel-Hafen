...
const translations = {
  de: {
    ...
    check: "Update prüfen", replace: "Container ersetzen", update: "Update verfügbar", noMatches: "Keine passenden Container gefunden.", delete: "Löschen", settings: "Einstellungen", moreActions: "Weitere Aktionen", comingSoon: "Wird mit der Funktion zum Ändern von Container-Einstellungen verfügbar",
  ...
  en: {
    ...
    check: "Check update", replace: "Replace container", update: "Update available", noMatches: "No matching containers found.", delete: "Delete", settings: "Settings", moreActions: "More actions", comingSoon: "Available with the upcoming container settings feature",
...
const emptyDraft = () => ({ name: "", image: "", cpus: "2", memoryMb: "1024", start: true, ports: [], volumes: [], variables: [] });
...
function App() {
  ...
  useEffect(() => { load(); loadRuntimeStatus(); request("/api/auth/session").then(setAuth).catch(() => setAuth({ authenticated: false })); }, []);
  useEffect(() => {
